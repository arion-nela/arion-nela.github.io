...
export default function F1RacesTierC2 () {
  ...
  races.push({ id: 3, name: 'Paul Ricard', date: new Date(2022, 11, 14).getTime(), flag: '/fr.png' })
  races.push({ id: 4, name: 'Suzuka', date: new Date(2023, 0, 4).getTime(), flag: '/jp.png' })
  races.push({ id: 5, name: 'Hungaroring', date: new Date(2023, 0, 11).getTime(), flag: '/hu.png' })
  races.push({ id: 6, name: 'Spielberg (Sprint)', date: new Date(2023, 0, 18).getTime(), flag: '/at.png' })
  races.push({ id: 7, name: 'Baku', date: new Date(2023, 0, 25).getTime(), flag: '/az.png' })
  races.push({ id: 8, name: 'Shanghai', date: new Date(2023, 1, 1).getTime(), flag: '/cn.png' })
  races.push({ id: 9, name: 'Austin (Sprint)', date: new Date(2023, 1, 8).getTime(), flag: '/us.png' })
  ...
  races.push({ id: 12, name: 'Interlagos', date: new Date(2023, 2, 1).getTime(), flag: '/br.png' })
  return (
