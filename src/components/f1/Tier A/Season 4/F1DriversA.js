...
export default function F1DriversA4 () {
  const drivers = []
  ...
  drivers.push({ name: 'Anton Chebotarov', points: '0', order: '0', teamBackground: 'rgba(245, 128, 32, 0.2)', teamName: 'McLaren', teamImage: '/mclaren.png', flag: '/ua.png' })
  ...
  drivers.push({ name: 'Adam', points: '0', order: '0', teamBackground: 'rgba(201, 45, 75, 0.2)', teamName: 'Alfa Romeo', teamImage: '/alfa-romeo.png', flag: '/en.png' })
  ...
  drivers.push({ name: 'Jack Grossart', points: '0', order: '0', teamBackground: 'rgba(182, 186, 189, 0.2)', teamName: 'Haas', teamImage: '/haas.png', flag: '/gb-sct.png' })
