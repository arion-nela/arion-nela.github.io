...
export default function F1DriversB3 () {
  const drivers = []
  drivers.push({ name: 'Kisiel', points: '15', teamBackground: 'rgba(54, 113, 198, 0.2)', teamName: 'Red Bull', teamImage: '/red-bull.png', flag: '/pl.png' })
  drivers.push({ name: 'Lando', points: '6', teamBackground: 'rgba(54, 113, 198, 0.2)', teamName: 'Red Bull', teamImage: '/red-bull.png', flag: '/pl.png' })
  drivers.push({ name: 'Marcel Hol', points: '23', teamBackground: 'rgba(249, 21, 54, 0.2)', teamName: 'Ferrari', teamImage: '/ferrari.png', flag: '/hu.png' })
  drivers.push({ name: 'Eymen Akin', points: '0', teamBackground: 'rgba(249, 21, 54, 0.2)', teamName: 'Ferrari', teamImage: '/ferrari.png', flag: '/tr.png' })
  drivers.push({ name: 'HackoDK', points: '41', order: '0', teamBackground: 'rgba(108, 211, 191, 0.2)', teamName: 'Mercedes', teamImage: '/mercedes.png', flag: '/dk.png' })
  drivers.push({ name: 'Vaipz', points: '0', teamBackground: 'rgba(108, 211, 191, 0.2)', teamName: 'Mercedes', teamImage: '/mercedes.png', flag: '/dk.png' })
  drivers.push({ name: 'Adam', points: '123', teamBackground: 'rgba(34, 147, 209, 0.2)', teamName: 'Alpine', teamImage: '/alpine.png', flag: '/gb-eng.png' })
  drivers.push({ name: 'Vade', points: '0', teamBackground: 'rgba(34, 147, 209, 0.2)', teamName: 'Alpine', teamImage: '/alpine.png', flag: '/se.png' })
  drivers.push({ name: 'Uklucasw', points: '15', teamBackground: 'rgba(245, 128, 32, 0.2)', teamName: 'McLaren', teamImage: '/mclaren.png', flag: '/gb-eng.png' })
  drivers.push({ name: 'Spyzer', points: '7', teamBackground: 'rgba(245, 128, 32, 0.2)', teamName: 'McLaren', teamImage: '/mclaren.png', flag: '/nl.png' })
  drivers.push({ name: 'Emil Lundell', points: '99', teamBackground: 'rgba(201, 45, 75, 0.2)', teamName: 'Alfa Romeo', teamImage: '/alfa-romeo.png', flag: '/se.png' })
  drivers.push({ name: 'Bald', points: '16', teamBackground: 'rgba(201, 45, 75, 0.2)', teamName: 'Alfa Romeo', teamImage: '/alfa-romeo.png', flag: '/ie.png' })
  drivers.push({ name: 'Durrrp', points: '3', teamBackground: 'rgba(53, 140, 117, 0.2)', teamName: 'Aston Martin', teamImage: '/aston-martin.png', flag: '/dk.png' })
  drivers.push({ name: 'Jan Švrdlik', points: '4', teamBackground: 'rgba(53, 140, 117, 0.2)', teamName: 'Aston Martin', teamImage: '/aston-martin.png', flag: '/cz.png' })
  drivers.push({ name: 'Rocky', points: '16', teamBackground: 'rgba(182, 186, 189, 0.2)', teamName: 'Haas', teamImage: '/haas.png', flag: '/de.png' })
  drivers.push({ name: 'Ukrain Aim', points: '10', teamBackground: 'rgba(182, 186, 189, 0.2)', teamName: 'Haas', teamImage: '/haas.png', flag: '/az.png' })
  drivers.push({ name: 'Dopichu', points: '41', order: '1', teamBackground: 'rgba(94, 143, 170, 0.2)', teamName: 'AlphaTauri', teamImage: '/alpha-tauri.png', flag: '/fi.png' })
  drivers.push({ name: 'Hugyme', points: '37', teamBackground: 'rgba(94, 143, 170, 0.2)', teamName: 'AlphaTauri', teamImage: '/alpha-tauri.png', flag: '/gb-eng.png' })
  drivers.push({ name: 'Bartusg5', points: '11', teamBackground: 'rgba(55, 190, 221, 0.2)', teamName: 'Williams', teamImage: '/williams.png', flag: '/hu.png' })
  drivers.push({ name: 'Bolar', points: '0', teamBackground: 'rgba(55, 190, 221, 0.2)', teamName: 'Williams', teamImage: '/williams.png', flag: '/nl.png' })
